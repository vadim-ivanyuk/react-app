...
describe('Courses test', () => {
	...
	it('Courses should display amount of CourseCard equal length of courses array and courses should display Empty container if courses array length is empty', () => {
		expect(screen.queryAllByTestId('courseCard').length).toEqual(
			mockCourses.length
		);
	});
});
